...
export default function About() {
  return (
    <>
      {/* Parrafito de vps */}
      <div id="provisioning" className="my-16 mx-auto max-w-4xl lg:text-center">
      ...
      <div className="py-24 pt-16">
        <div id="process" className="mx-auto max-w-7xl px-6 lg:px-8">
      ...
      <div className="py-24 pt-16">
        <div id="setup" className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div className="lg:pr-8 lg:pt-4">
              <div className="lg:max-w-lg">
                <h2 className="text-base font-semibold leading-7 text-indigo-600">
