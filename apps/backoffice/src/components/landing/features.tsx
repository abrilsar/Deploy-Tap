...
const features = [
  {
    name: "Automatic deployment of your services",
    description:
  ...
  },
  {
    ...
    description:
      "We offer you security through SSH connections, SSL certificates and a firewall, to protect your application and your users' data.",
    icon: LockClosedIcon,
  },
];
  ...
  return (
    <div key={name} className="relative pl-16">
      <dt className="text-base font-semibold leading-7 text-gray-900">
        <div className="absolute left-0 top-0 flex mt-2 sm:mt-0 h-10 w-10 items-center justify-center rounded-lg bg-customColor">
